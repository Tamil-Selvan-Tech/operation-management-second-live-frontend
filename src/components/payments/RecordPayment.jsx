  ...
  return `<style>
    *{box-sizing:border-box} .receipt-page{width:794px;min-height:1123px;padding:22px 28px 0;background:#fff;color:#132044;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.3}
    ...
    <div class="two-column">
      <section class="card"><div class="section-title">STUDENT DETAILS</div>${detailRow("Student Name", studentName)}${detailRow("Student ID", studentId)}${detailRow("Course", courseName)}${detailRow("Batch", batchName)}${detailRow("Contact Number", studentPhone)}</section>
