  ...
  return `<style>
    *{box-sizing:border-box} .receipt-page{width:794px;min-height:1123px;padding:22px 28px 0;background:#fff;color:#132044;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.3}
    ...
    <div class="two-column">
      <section class="card"><div class="section-title">STUDENT DETAILS</div>${detailRowWithColon("Student Name", studentName)}${detailRowWithColon("Student ID", studentId)}${detailRowWithColon("Course", courseName)}${detailRowWithColon("Batch", batchName)}${detailRowWithColon("Contact Number", studentPhone)}</section>
      <section class="card"><div class="section-title">PAYMENT DETAILS</div>${detailRowWithColon("Payment For", paymentFor)}${detailRowWithColon("Payment Mode", paymentMode)}${detailRowWithColon("Transaction Ref", transactionReference)}${detailRowWithColon("Collected By", collectedBy)}${detailRowWithColon("Remarks", notes)}</section>
    </div>
    ...
    <section class="payment-status"><div class="payment-status-line"><strong>PAYMENT STATUS:</strong><span class="payment-status-value ${balance > 0 ? "pending" : "paid"}">${balance > 0 ? "Partially Paid" : "Paid"}</span></div><span class="payment-status-message">Thank you! Your payment has been recorded successfully.</span></section>
