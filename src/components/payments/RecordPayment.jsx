  ...
  return `<style>
    *{box-sizing:border-box} .receipt-page{width:794px;min-height:1123px;padding:22px 28px 0;background:#fff;color:#132044;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.3}
    ...
    <div class="two-column summary-columns">
      ...
      <section class="card installment-card"><div class="section-title">INSTALLMENT DETAILS</div><table><thead><tr><th style="font-size:6px !important;font-weight:700;line-height:1;white-space:nowrap">INSTALLMENT</th><th style="font-size:6px !important;font-weight:700;line-height:1;white-space:nowrap">DUE DATE</th><th style="font-size:6px !important;font-weight:700;line-height:1;white-space:nowrap">AMOUNT</th><th style="font-size:6px !important;font-weight:700;line-height:1;white-space:nowrap">STATUS</th></tr></thead><tbody>${installmentRows || `<tr><td colspan="4" class="empty">No installment schedule available</td></tr>`}</tbody></table></section>
    </div>
