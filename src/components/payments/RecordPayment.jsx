...
export const buildModernPaymentReceiptHtml = ({
  ...
  const optionalText = (value) => value === undefined || value === null || String(value).trim() === "" ? "-" : value;
  ...
  const detailRowWithColon = (label, value) => `<div class="detail-row colon-detail-row"><span>${safe(label)}</span><span class="detail-colon">:</span><strong>${String(value || "-").startsWith("&#8377;") ? value : safe(value || "-")}</strong></div>`;

  return `<style>
    *{box-sizing:border-box} .receipt-page{width:794px;height:auto;min-height:0;padding:22px 28px 24px;background:#fff;color:#132044;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.3}
    .receipt-header{display:flex;justify-content:space-between;gap:18px;padding-bottom:12px;border-bottom:1px solid #cbd5e1}.brand-block{display:flex;align-items:flex-start;gap:10px;max-width:49%}.brand-logo{width:112px;height:52px;object-fit:contain}.institute-name{font-size:15px;font-weight:800;color:#102b67;text-transform:uppercase;letter-spacing:.2px}.address{margin-top:3px;line-height:1.3;color:#475569}.contact{margin-top:4px;color:#475569}.title-block{text-align:right;min-width:270px}.receipt-title{font-family:"Arial Narrow","Roboto Condensed",Arial,Helvetica,sans-serif;font-size:27px;line-height:1;font-weight:900;letter-spacing:1.5px;color:#102b67;margin:5px 0 18px;white-space:nowrap}.thank-you{display:inline-flex;align-items:center;justify-content:center;padding:6px 10px;border:1px solid #36a269;border-radius:8px;background:#f0faf4;color:#16834a;font-weight:800;white-space:nowrap}
    .meta-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:0;margin:12px 0;padding:9px 10px;border:1px solid #9fb1d2;border-radius:9px}.meta-grid .detail-row{display:flex;flex-direction:column;align-items:flex-start;justify-content:center;padding:4px 10px;border-right:1px dashed #b7c3d8;border-bottom:0;min-height:42px}.meta-grid .detail-row:nth-child(3n){border-right:0}.meta-grid .detail-row:nth-child(n+4){border-top:0;padding-top:7px}.meta-grid .detail-row span{display:block;text-transform:uppercase;font-size:8px;letter-spacing:.5px}.meta-grid .detail-row strong{display:block;margin-top:3px;font-size:11px;line-height:1.15;overflow-wrap:anywhere}
    .two-column{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;align-items:start}.two-column:not(.summary-columns){align-items:stretch}.two-column:not(.summary-columns)>.card{height:100%}.summary-left-column{display:flex;flex-direction:column;gap:6px;min-width:0}.card{border:1px solid #bdcbe1;border-radius:8px;overflow:hidden;background:#fff;page-break-inside:avoid}.section-title{font-family:"Arial Narrow","Roboto Condensed",Arial,Helvetica,sans-serif;padding:6px 10px;background:#102b67;color:#fff;font-size:10.5px;font-weight:800;letter-spacing:.8px;line-height:1.15}.two-column:not(.summary-columns)>.card>.section-title{padding:8px 10px}.summary-left-column>.fee-card>.section-title{padding:8px 10px}.summary-columns>.installment-card>.section-title{padding:8px 10px}.detail-row{display:flex;justify-content:space-between;gap:10px;padding:5px 10px;border-bottom:1px solid #edf1f7;min-height:23px}.two-column:not(.summary-columns) .detail-row{padding:7px 10px;min-height:28px}.fee-card .detail-row{padding:7px 10px;min-height:28px}.fee-card .total-row{padding:9px 10px}.detail-row span{color:#475569}.detail-row strong{text-align:right;color:#132044;font-weight:700;overflow-wrap:anywhere;min-width:0}.colon-detail-row{display:grid;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr);align-items:start}.colon-detail-row strong{text-align:left;overflow-wrap:anywhere}.detail-colon{color:#132044!important;font-weight:700}.detail-row.green strong{color:#16834a}.table-head{display:flex;justify-content:space-between;padding:5px 10px;background:#f1f5fa;color:#102b67;font-size:9px;font-weight:800;letter-spacing:.35px}.total-row{display:flex;justify-content:space-between;padding:7px 10px;border-top:1px dashed #98a9c5;font-size:12px;font-weight:800}.balance strong{color:#dc3b3b}.amount-box{position:relative;margin:10px 0;padding:10px;text-align:center;border:1px dashed #47ae76;border-radius:9px;background:#f4fbf6;page-break-inside:avoid}.amount-label{font-family:"Arial Narrow","Roboto Condensed",Arial,Helvetica,sans-serif;font-size:11px;font-weight:800;letter-spacing:.7px;color:#16834a}.amount{margin:1px 0;font-size:27px;font-weight:900;letter-spacing:.3px;color:#159447}.words{font-size:10px;color:#475569;overflow-wrap:anywhere}.received{position:absolute;right:18px;top:19px;padding:6px 8px;border:2px solid #25a35b;border-radius:50%;color:#16834a;font-size:9px;font-weight:900;transform:rotate(-12deg)}
    table{width:100%;table-layout:fixed;border-collapse:collapse;font-size:9px}th,td{padding:5px 6px;border-bottom:1px solid #e3eaf3;text-align:left;vertical-align:top;overflow-wrap:anywhere}th{padding-bottom:9px;background:#f1f5fa;color:#102b67;font-size:6px;font-weight:700;letter-spacing:.1px;line-height:1}th:nth-child(1),td:nth-child(1){width:34%}th:nth-child(2),td:nth-child(2){width:26%;white-space:normal}th:nth-child(3),td:nth-child(3){width:21%}th:nth-child(4),td:nth-child(4){width:19%}th:nth-child(n+3),td:nth-child(n+3){text-align:right}th:nth-child(4){text-align:right}.installment-card table{margin-top:8px}.status{display:inline-flex;align-items:center;justify-content:center;padding:2px 6px;border:1px solid;border-radius:10px;font-size:8px;font-weight:800;letter-spacing:.2px;white-space:nowrap}.status.paid{border-color:#54bc7f;color:#16834a;background:#f1fbf4}.status.partial{border-color:#e3a52e;color:#a26000;background:#fff8e7}.status.pending{border-color:#f1a33d;color:#b96900;background:#fff8ec}.installment-status{font-size:8px;font-weight:800;letter-spacing:.2px;white-space:nowrap}.installment-status.paid{color:#16834a}.installment-status.partial{color:#a26000}.installment-status.pending{color:#b96900}.empty{text-align:center!important;color:#64748b}.next-payment{margin:6px 6px 6px;border:1px solid #9dbcf0;border-radius:6px;background:#f4f8ff;page-break-inside:avoid}.next-payment .section-title{padding:5px 8px 10px;background:transparent;color:#164a9c;border-bottom:1px solid #cdddf7}.next-grid{display:grid;grid-template-columns:1fr 1fr;gap:3px;padding:6px 8px}.next-grid strong{text-align:left}.next-amount{color:#16834a}.payment-status{display:block;margin-top:10px;padding:8px 10px;border:1px solid #f3b65b;border-radius:7px;background:#fff9ef;color:#743f0b;page-break-inside:avoid}.payment-status-line{display:flex;align-items:center;gap:6px}.payment-status>strong{font-family:"Arial Narrow","Roboto Condensed",Arial,Helvetica,sans-serif;color:#9d5500;letter-spacing:.6px}.payment-status-value{display:block;text-align:left;color:#16834a;font-size:10px;font-weight:800;letter-spacing:.2px;white-space:nowrap}.payment-status-value.pending{color:#a26000}.payment-status-message{display:block;margin-top:4px;text-align:center;color:#7b5b36}.receipt-history{margin-top:10px;page-break-inside:auto}.receipt-history table{font-size:8px}.receipt-history th,.receipt-history td{width:auto!important}.receipt-footer{display:flex;justify-content:space-between;gap:10px;margin:14px -28px 0;padding:8px 28px;background:#102b67;color:#fff;font-size:8px;line-height:1.2;page-break-inside:avoid}
    @media print{.receipt-page{margin:0}.card,.meta-grid,.amount-box,.payment-status,.next-payment{page-break-inside:avoid}.receipt-history tr{page-break-inside:avoid}}
    ...
    <header class="receipt-header">
      <div class="brand-block">
        ...
        <div><div class="institute-name">${safe(instituteName)}</div>
          ${branchAddress && branchAddress !== "-" ? `<div class="address">${safe(branchAddress)}</div>` : ""}
          ${branchPhone && branchPhone !== "-" || branchEmail && branchEmail !== "-" ? `<div class="contact">${branchPhone && branchPhone !== "-" ? safe(branchPhone) : ""}${branchEmail && branchEmail !== "-" ? `&nbsp;&nbsp;|&nbsp;&nbsp;${safe(branchEmail)}` : ""}</div>` : ""}
        </div>
      </div>
    ...
    <div class="two-column summary-columns">
      <div class="summary-left-column"><section class="card fee-card"><div class="section-title">FEE SUMMARY</div><div class="table-head"><span>DESCRIPTION</span><span>AMOUNT</span></div>${detailRow("Total Course Fee", money(totalCourseFee))}${hasValue(discount) ? detailRow("Discount", money(discount)) : ""}${hasValue(tax) ? detailRow("Tax / GST", money(tax)) : ""}${hasValue(lateFee) ? detailRow("Late Fee", money(lateFee)) : ""}${detailRow("Previously Paid", money(previouslyPaid))}<div class="detail-row green"><span>Current Payment</span><strong>${money(currentPayment)}</strong></div><div class="total-row"><span>Total Paid</span><strong>${money(totalPaid)}</strong></div><div class="detail-row balance"><span>Remaining Balance</span><strong>${money(balance)}</strong></div></section>${nextPayment}</div>
      <section class="card installment-card"><div class="section-title">INSTALLMENT DETAILS</div><table><thead><tr><th style="font-size:6px !important;font-weight:800 !important;line-height:1;white-space:nowrap">INSTALLMENT</th><th style="font-size:6px !important;font-weight:800 !important;line-height:1;white-space:nowrap">DUE DATE</th><th style="font-size:6px !important;font-weight:800 !important;line-height:1;white-space:nowrap">AMOUNT</th><th style="font-size:6px !important;font-weight:800 !important;line-height:1;white-space:nowrap">STATUS</th></tr></thead><tbody>${installmentRows || `<tr><td colspan="4" class="empty">No installment schedule available</td></tr>`}</tbody></table></section>
    </div>

    <section class="payment-status"><div class="payment-status-line"><strong>PAYMENT STATUS:</strong><span class="payment-status-value ${String(paymentStatus || "").toLowerCase() === "paid" || (!paymentStatus && balance <= 0) ? "paid" : "pending"}">${safe(optionalText(paymentStatus || (balance > 0 ? "Partially Paid" : "Paid")))}</span></div><span class="payment-status-message">Thank you! Your payment has been recorded successfully.</span></section>
