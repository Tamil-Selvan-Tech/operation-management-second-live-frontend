...
export function normalizeStudent(student) {
  ...
  return {
    ...
    classSchedule: student.classSchedule || student.schedule || student.courseSchedule || student.course?.schedule || '',
    courseSchedule: student.courseSchedule || student.classSchedule || student.schedule || student.course?.courseSchedule || student.course?.schedule || '',
    courseDuration: student.courseDuration || student.duration || student.course?.duration || student.course?.courseDuration || '',
    totalHours: student.totalHours || student.courseHours || student.hours || student.course?.totalHours || student.course?.hours || '',
    hoursPerDay: student.hoursPerDay || '',
    requiredTeachingDays: student.requiredTeachingDays || '',
    actualTeachingDays: student.actualTeachingDays || '',
    calendarDurationDays: student.calendarDurationDays || '',
