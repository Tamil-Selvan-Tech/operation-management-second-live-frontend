...
export const cancelFacultyTest = (testId) => request(`/exams/faculty/tests/${testId}/cancel`, { method: 'POST' }).then(data)
export const cancelFacultyRetest = (retestId) => request(`/exams/faculty/retests/${retestId}/cancel`, { method: 'POST' }).then(data)
...
export const cancelFacultyAssessment = (id) => request(`/exams/faculty/assessments/${id}/cancel`, { method: 'POST' }).then(data)
